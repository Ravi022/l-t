...
export default function ModelViewer() {
  ...
  return (
    <Canvas style={{ width: '800px', height: '740px', position: 'relative', top:'0px', left:'0px', backgroundImage:"url(https://imgcdn.stablediffusionweb.com/2024/3/23/ace50a5e-4d61-4589-a2f3-5ad7db404f50.jpg)", backgroundSize: 'cover'}} camera={{position: [0, 2, -6] }}  onCreated={({ gl, camera }) => {
      ...
      <Model url="src/components/models/Ram-Mandir.gltf" /> {/* Replace with the actual URL */}
    </Canvas>
  );
}
